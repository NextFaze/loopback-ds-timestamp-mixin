...
test('loopback datasource timestamps', function(tap) {
  ...
  tap.test('boot options', function(t) {
    ...
    t.test('should default required on createdAt and updatedAt ', function(tt) {
      ...
      tt.equal(Widget.definition.properties.createdAt.required, true);
      tt.equal(Widget.definition.properties.updatedAt.required, true);
      tt.end();
    });
    ...
    t.test('should have optional createdAt and updatedAt', function(tt) {
      ...
      tt.equal(Widget.definition.properties.createdAt.required, false);
      tt.equal(Widget.definition.properties.updatedAt.required, false);
      tt.end();
    });
